...
import (
	...
	"github.com/gaabrielbrocco/go-gateway/internal/domain"
)
...
func (r *AccountRepository) Save(account *domain.Account) error {
	...
	// _ porque exec retorna 2 valores (quantidade de linhas que foram inseridas nesse caso e retorna um erro)
	// exec vai substituir os valores, ex: $1 = account.ID
	_, err = stmt.Exec(
...
// Scan acessa a variável account na memória e pega o ID e coloca no ID do Account por exemplo
